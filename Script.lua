...
elseif UserID == 517872679 or UserID == 517872679  then  
...
if UserID == 517872679 or UserID == 517872679 then return sendMsg(msg.chat_id_,msg.id_,"- لا يمكنك تنفيذ الامر ضد مطور السورس \n") end
...
msg = arg.msg
if UserID == 517872679 or UserID == 517872679 then return sendMsg(msg.chat_id_,msg.id_,"- لا يمكنك تنفيذ الامر ضد مطور السورس ") end
NameUser = Hyper_Link_Name(data)
...
return '- اصدار سورس كوبا : *v'..version..'* '
end

if MsgText[1] == 'تحديث السورس' then
if not msg.SudoBase then return "- هذا الامر يخص {المطور الاساسي} فقط  \n" end
local GetVerison = https.request('https://CuBau.github.io/GetVersion.txt') or "0"
...
sendMsg(arg.chat_id_,arg.id_,'- عذرا اسم الملف غير مدعوم للنظام او لا يتوافق مع سورس كوبا يرجى جلب الملف الاصلي الذي قمت بسحبه وبدون تعديل ع الاسم ')
end  
else
...
- Cuba TEAM 
┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉
- [Source Channel](https://t.me/QF_QQ)

- [Source Cuba](https://t.me/GG11G)
...
if not msg.SudoBase then return "- هذا الامر يخص {المطور الاساسي} فقط  \n" end
local Get_Files, res = https.request("https://CuBau.github.io/GetFiles.json")
print(Get_Files)
print(res)
if res == 200 then
...
local Get_Files, res = https.request("https://raw.githubusercontent.com/CuBau/CuBau.github.io/master/plugins/"..FileName)
if res == 200 then
...
NameUser = Hyper_Link_Name(data)
if UserID == 517872679 or UserID == 517872679 then 
...
if FwdUser == 517872679 or FwdUser == 517872679 then 
...
if CheckUserinstall(arg.USERNAME) then return sendMsg(arg.ChatID,arg.MsgID,"- عذرا هذا الحساب محظور من سيرفرات حماية كوبا ") end
